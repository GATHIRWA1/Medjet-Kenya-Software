                            ...
                            <div class="form-group">
							  ...
							  <div class="form-group">
                                ...
                                <div v-if="submitted && !$v.user.phone.required" class="invalid-feedback">Phone Number is required</div>
                                    <div class="invalid-feedback"><span  v-if="!$v.user.phone.numeric"> Phone should a valid  phone number</span>  </div> 
                                     <div class="invalid-feedback"> <span  v-if="!$v.user.phone.pminLength"> Should be atleast 10 characters</span> </div> 
                                      <div class="invalid-feedback"><span  v-if="!$v.user.phone.pmaxLength"> Should not exceed 12 characters</span>  </div> 
...
import { required, email, minLength, sameAs ,numeric ,maxLength } from "vuelidate/lib/validators";
export default {
name: "app",
        data() {
            return {
        ...
        validations: {
            user: {
                firstName: { required , },
                lastName: { required },
				phone:{required , numeric ,PminLength: minLength(10) , pmaxLength: maxLength(14)},
...
fb.auth().createUserWithEmailAndPassword(this.user.email , this.user.password).then ((user)=>{
